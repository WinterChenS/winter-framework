...
/**
 * DESC加解密，JS des加密和java des加密统一（三组密钥）
 * 
 * <p>目前只用在验证客户端是否授权登录</p>
 * 
 * @author huajiejun
 * @version 创建时间：2017年5月25日 下午9:19:29
 */
...
public class DesEncrypt {
     ...
     * @param key3 密钥3
     */
    public DesEncrypt(String key1,String key2,String key3) {
    	this.key1 = key1;
    	this.key2 = key2;
    	this.key3 = key3;
    }
     ...
     * @return: String
     * @author: huajiejun
     * @version 创建时间：2017年5月25日 下午9:20:20
     */
    public String strEnc(String data, String firstKey, String secondKey,String thirdKey) {
        ...
        if (leng > 0) {
            if (leng < 4) {
                ...
                if(encByte==null||encByte.length<64){
                	return null;
                }
     ...
     * @return: String
     * @author: huajiejun
     * @version 创建时间：2017年5月25日 下午9:21:19
     */
	...
	public String strDec(String data, String firstKey, String secondKey,
        ...
        for (i = 0; i < iterator; i++) {
            ...
            if(decByte==null||decByte.length!=64){
            	return null;
            }
     ...
     * @return: String
     * @author: huajiejun
     * @version 创建时间：2017年5月25日 下午9:33:46
     */
     ...
     * @return: String
     * @author: huajiejun
     * @version 创建时间：2017年5月25日 下午9:33:42
     */
