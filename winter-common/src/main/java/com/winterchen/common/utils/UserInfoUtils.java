...
public class UserInfoUtils {
    ...
    public static String getUserTypeByCurrent() {
        ...
        if (attributes != null) {
            HttpServletRequest request = attributes.getRequest();
            return request.getHeader(ConstantsUtil.USER_TYPE);
        }else{
            return "";
        }
    }
    ...
    public static String getIpAddressByCurrent(){
        ...
        if (attributes != null) {
            HttpServletRequest request = attributes.getRequest();
            return request.getHeader(ConstantsUtil.IP_ADDRESS);
        }else{
            return "";
        }
    }
    ...
    public static String getUserNameByCurrent() {
        ...
        if (attributes != null) {
            HttpServletRequest request = attributes.getRequest();
            return new String(request.getHeader(ConstantsUtil.USER_NAME).getBytes(), StandardCharsets.UTF_8);
        }else{
            return "";
        }
    ...
    public static String getSessionKeyByCurrent() {
        ...
        if (attributes != null) {
            HttpServletRequest request = attributes.getRequest();
            return request.getHeader(ConstantsUtil.SESSION_KEY);
        }else{
            return null;
        }
