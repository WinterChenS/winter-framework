...
public class DateUtil {
     ...
     * ISODate
     */
    public static final String ISODATE_SSS_FORMAT_PATTERN = "yyyy-MM-dd'T'HH:mm:ss.SSS'Z'";
    /**
     * HH:mm:ss
     */
    ...
    public static Date dateToISODate(String dateStr){
        ...
        Date date = format(dateStr, DATETIME_FORMAT_PATTERN);

        SimpleDateFormat format = new SimpleDateFormat(ISODATE_SSS_FORMAT_PATTERN);
    ...
    public static void main(String[] args) {
        ...
        System.err.println(getCurrentMonth()+1);
        System.err.println(getCurrentHour());
